...
public class ContactEmailDao_Impl implements ContactEmailDao {
  ...
  @Override
  public List<ContactAndAllEmails> loadContactAndEmails() {
    ...
    try {
      ...
      final List<ContactAndAllEmails> _result = new ArrayList<ContactAndAllEmails>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final ContactAndAllEmails _item;
